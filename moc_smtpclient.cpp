...
QT_MOC_LITERAL(51, 726, 15), // "_TLS_0_STARTTLS"
QT_MOC_LITERAL(52, 742, 14), // "_TLS_1_ENCRYPT"
QT_MOC_LITERAL(53, 757, 11), // "_TLS_2_EHLO"
QT_MOC_LITERAL(54, 769, 13), // "_AUTH_PLAIN_0"
QT_MOC_LITERAL(55, 783, 13), // "_AUTH_LOGIN_0"
QT_MOC_LITERAL(56, 797, 18), // "_AUTH_LOGIN_1_USER"
QT_MOC_LITERAL(57, 816, 18), // "_AUTH_LOGIN_2_PASS"
QT_MOC_LITERAL(58, 835, 12), // "_MAIL_0_FROM"
QT_MOC_LITERAL(59, 848, 17), // "_MAIL_1_RCPT_INIT"
QT_MOC_LITERAL(60, 866, 12), // "_MAIL_2_RCPT"
QT_MOC_LITERAL(61, 879, 12), // "_MAIL_3_DATA"
QT_MOC_LITERAL(62, 892, 17) // "_MAIL_4_SEND_DATA"
...
void SmtpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::error)) {
                *result = 0;
            }
        }
        {
            typedef void (SmtpClient::*_t)(SmtpClient::ClientState );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::stateChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (SmtpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::connected)) {
                *result = 2;
            }
        }
        {
            typedef void (SmtpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::readyConnected)) {
                *result = 3;
            }
        }
        {
            typedef void (SmtpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::authenticated)) {
                *result = 4;
            }
        }
        {
            typedef void (SmtpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::mailSent)) {
                *result = 5;
            }
        }
        {
            typedef void (SmtpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::mailReset)) {
                *result = 6;
            }
        }
        {
            typedef void (SmtpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SmtpClient::disconnected)) {
                *result = 7;
            }
        }
    }
